...
if total_calories > daily_limit:
    status_message = " Warning: You have exceeded your daily calorie limit!This is serious!!"
else:
    status_message = "Good job! You are within your daily calorie limit.Great!!"
